# Definición de Agentes de IA en OpositaIA (Runtime)

> **⚠️ NOTA IMPORTANTE SOBRE METODOLOGÍA DE DESARROLLO:**
> Este documento describe los **Agentes de IA que operan DENTRO de la aplicación OpositaIA** (ej: Tutor, Examinador, Generador de Casos) para dar servicio al usuario final.
>
> NO confundir con los **Agentes de Desarrollo del Método BMad** (Architect, Scrum Master, Developer) que se utilizan para *construir* este software. La definición y configuración de los agentes de desarrollo se encuentra en la carpeta `.bmad/`.
