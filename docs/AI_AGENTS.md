...
*   **Paso 1: Generación de Texto**
    ...
    *   **Modelo:** `gemini-2.5-pro`
    *   **Justificación:** Se necesita un modelo potente para crear un conjunto de flashcards de alta calidad (pregunta/respuesta) y, crucialmente, para idear un *prompt* de imagen que sea ingenioso, descriptivo y divertido.
    *   **Configuración Clave:**
        *   `model: 'gemini-2.5-pro'`
        *   `responseMimeType: "application/json"`
