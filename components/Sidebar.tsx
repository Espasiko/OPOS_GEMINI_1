...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView }) => {
  const primaryNavItems = [
    ...
    {
      view: AppView.CASE_GENERATOR,
      label: 'Generador de Casos',
  ...
  const toolsNavItems = [
    ...
    {
      view: AppView.COMPARATOR,
      label: 'Comparador de Leyes',
      icon: <CompareIcon className="h-5 w-5" />,
    },
    {
      view: AppView.FLASHCARDS,
      label: 'Tarjetas y Memes',
    ...
    <nav className="flex flex-col w-64 bg-slate-100 dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800 p-4">
      ...
      <div className="flex-grow flex flex-col justify-between overflow-y-auto pr-2">
        <div className="space-y-6">
          <div>
            <h3 className="px-3 mb-2 text-xs font-semibold uppercase text-slate-400 tracking-wider">
              Principal
            </h3>
