    ...
    <div className="w-full bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 p-1">
      ...
      <div className="p-4">
        ...
        {activeTab === 'file' && (
          <div className="flex items-center justify-center w-full">
            <label
              ...
              className="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-300 dark:border-slate-600 border-dashed rounded-lg cursor-pointer bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600"
            >
        ...
        {fileName && activeTab === 'file' && (
          <div className="mt-2 text-sm text-center text-slate-600 dark:text-slate-300">
        ...
        {showTextField && (
          <button
            ...
            className="mt-4 w-full px-4 py-2 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 disabled:bg-slate-400 flex items-center justify-center gap-2"
          >
            {isLoading ? (
