#!/usr/bin/env python3
"""
Agente Completo: Mistral 8B + MCP + RAG
...
def generar_10_qa():
    ...
    print("Groq llama-3.3-70b + MCP + RAG Local")
    print("="*70)
    ...
    tareas = [
        ...
        {
            "tipo": "comparacion",
            "tema": "diferencia entre incapacidad permanente parcial y total LGSS",
            "dificultad": "alta",
            "instruccion": "Genera una pregunta que compare IP parcial vs IP total, explicando diferencias clave en porcentajes y efectos."
        },
        {
            "tipo": "comparacion",
            "tema": "moción de censura vs cuestión de confianza Constitución",
            "dificultad": "media",
        ...
        {
            "tipo": "razonamiento",
            "tema": "caso práctico incapacidad temporal que supera 365 días",
            "dificultad": "alta",
        ...
        {
            "tipo": "relacion",
            "tema": "relación entre LGSS y Constitución en derechos sociales",
            "dificultad": "media",
