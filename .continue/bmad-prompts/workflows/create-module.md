...
Ejecuta el workflow **create-module**.

**Descripción**: Interactive workflow to build complete BMAD modules with agents, workflows, and installation infrastructure

**Instrucciones de ejecución**:

1. Lee el archivo completo del workflow: `/home/spas/OPOS_GEMINI_1/.bmad/.bmad/bmb/workflows/create-module/workflow.md`
